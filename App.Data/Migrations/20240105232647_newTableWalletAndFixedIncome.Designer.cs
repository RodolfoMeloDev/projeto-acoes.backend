...
namespace App.Data.Migrations
{
    ...
    [Migration("20240105232647_newTableWalletAndFixedIncome")]
    partial class newTableWalletAndFixedIncome
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Entities.FixedIncomeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("ValueInitial")
            ...
            modelBuilder.Entity("App.Domain.Entities.HistoryFixedIncomeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("App.Domain.Entities.WalletEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("App.Domain.Entities.FixedIncomeEntity", b =>
                {
                    b.HasOne("App.Domain.Entities.WalletEntity", "Wallet")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Domain.Entities.HistoryFixedIncomeEntity", b =>
                {
                    b.HasOne("App.Domain.Entities.FixedIncomeEntity", "FixedIncome")
                        .WithMany()
